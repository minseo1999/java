            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <br>
                        <label><input type="checkbox" name="topping" value="치즈추가">치즈추가</label>
                        <label><input type="checkbox" name="topping" value="베이컨">베이컨</label>
                        <label><input type="checkbox" name="topping" value="파인애플">파인애플</label>
                    </td>
                </tr>
                <tr>
                    <th>사이드</th>
                    <td>
                        ...
                        <label><input type="checkbox" name="side" value="환타">환타</label>
                    </td>
                </tr>
                <tr>
                    <th>결제방식</th>
