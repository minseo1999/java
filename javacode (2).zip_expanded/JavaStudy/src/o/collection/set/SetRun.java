...
public class SetRun {
	...
	public static void main(String[] args) {
		...
		//동일객체 : 각 개체마다 hashCode 결과가 일치하고, equals 메소드로 비교시 true 가 나올때
		
		// Student 에 equals() 오버라이딩 => "실제 각 필드에 담긴 데이터" 들이 다 일치하면 true, 일치하지 않으면 false
		// Student 에 hashCode() => "실제 담긴 문자열" 을 가지고 10진수의 형태로 만들어서 반환
		
		//his2.get() 인덱스의 개념이 없기 때문에 get 을 할 수 없음 -> 한개씩 무작위로 가져올 수 있음
		
		//hashSet에 담긴 객체들을 순차적으로 접근하는 방법
		//1. for each 문 사용
		for(Object s : hsi2) {
			System.out.println(hsi2);
		}
